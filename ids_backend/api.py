...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        ...
        await websocket.send_json({"type": "init", "alerts": broadcaster.get_alerts(20)})
        await websocket.send_json({"type": "init_stats", "stats": broadcaster.get_stats("icmp_packets_per_second", 60)})
